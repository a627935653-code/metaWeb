...
const RankingList = () => {
  ...
  const columns: TableProps<RankItem>["columns"] = [
    ...
    { title: "用户", dataIndex: "userName", key: "userName",render: (_, record) => {
        return (
          <div className="  flex flex-col justify-start items-start">
            <div className="font-semibold">
              {record?.userName} <span className="text-blue-500"> ({record?.key})</span>
            </div>
          </div>
        );
      },},
    ...
    >
      ...
      >
        ...
        <Space>
          ...
          >
            <Radio.Button value="1">充值</Radio.Button>
            <Radio.Button value="2">提现</Radio.Button>
          </Radio.Group>
          <Select
            value={sort}
