...
interface ApiChartData {
  ...
  topUp: { [key: string]: number | string };
}
...
const TransactionChart = () => {
  ...
  const transformApiData = (
    ...
    const series:ChartData["series"] = { success: [], withdrawal: [], conversion: [] ,topUp:[]};
    let xAxis: string[] = [];
    ...
    switch (mode) {
      ...
      case "2": {
        ...
        for (let i = 1; i <= loopCount; i++) {
          ...
          series.topUp.push(
            parseFloat(String(apiData?.topUp?.[key])) || 0
          );
        }
        break;
      }
  ...
  const getChartOption = (data: ChartData) => ({
    ...
    series: [
        ...
        type: "bar",
        stack: "总量",
        data: data.series.topUp,
        itemStyle: { color: "#29ff34ff" },
      },
      {
        name: "花费金额",
        type: "bar",
